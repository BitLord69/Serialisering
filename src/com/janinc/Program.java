...
public class Program {
    ...
    private void saveStore() {
        FileHandler.writeFile("store", PetStore.FILE_NAME, store);
    } // saveStore

    private void saveShoppers() {
        FileHandler.writeFile("shoppers", "shoppers.ser", shoppers);
//        shoppers.stream().forEach(o->FileHandler.writeFile("shoppers", String.format("%d.ser", System.currentTimeMillis()), o));
    } // saveShoppers
